...
From Yones
### listed below are the summary statistics of the dataset just to give you an idea of how it looks
```{r}
library(knitr)
knitr::kable(summary(cychecks_dept_data), col.names = c("Base Salary Date","Fiscal Year","gender","Place of Residence",
                                                        "Position","Total Salary Paid","Travel Subsistence","Base Salary",
                                                        "Organization","Department","ID","Position Simplified"))
```
...
```{r fig1_ex, echo = F, fig.cap="Professor 2018 salaries by gender and position in the Agronomy Department"}
...
```{r fig2_ex, echo = F, fig.cap="Number and gender of employees in professor positions in the Agronomy Dept. based on departmental affiliations in 2018"}
  sals_dept_profs %>%
   filter(gender %in% c("M", "F"),
          department == "AGRONOMY",
